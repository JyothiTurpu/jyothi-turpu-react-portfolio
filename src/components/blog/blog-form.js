...
export default class BlogForm extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      featured_image: '',
      id: '',
      apiUrl: 'https://jyothiturpu.devcamp.space/portfolio/portfolio_blogs',
      apiAction: 'post'
    }
  ...
  componentWillMount() {
    if(this.props.editMode) {
      this.setState({id: this.props.blog.id,
      title: this.props.blog.title,
      blog_status: this.props.blog.blog_status,
      content: this.props.blog.content,
      apiAction: 'patch',
      apiUrl: `https://jyothiturpu.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`
    });
    }
  }
  ...
  handleSubmit(event) {
      ...
      .then(response => {
        ...
        this.state.featured_image ? this.featuredImageRef.current.dropzone.removeAllFiles() : null;
  ...
  deleteImage(imageType) {
    ...
    .then(response => {
      console.log('Response from deleteImage inside a Blog ', response);
